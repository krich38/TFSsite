...
-- Coded by Dark ShaoOz, modified by yz85
function onSay(cid, words, param, channel)
	...
	if player:getStorageValue(storage) <= os.time() then
		...
		db.query("INSERT INTO `yz85_player_reports` (`id` ,`name` ,`posx` ,`posy` ,`posz` ,`report_description` ,`date`)VALUES (NULL ,  " .. db.escapeString(player:getName()) .. ",  '" .. player:getPosition().x .. "',  '" .. player:getPosition().y .. "',  '" .. player:getPosition().z .. "',  " .. db.escapeString(param) .. ",  '" .. os.time() .. "')")
