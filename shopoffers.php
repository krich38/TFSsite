...
<?php
if (!empty($_POST['buy'])) {
	if ($user_yz85_data['points'] >= $buy['points']) {
		?><td>You have <?php echo (int)($user_yz85_data['points'] - $buy['points']); ?> points. (<a href="buypoints.php">Buy points</a>).</td><?php
	} else {
		?><td>You have <?php echo $user_yz85_data['points']; ?> points. (<a href="buypoints.php">Buy points</a>).</td><?php
	}
} else {
	?><td>You have <?php echo $user_yz85_data['points']; ?> points. (<a href="buypoints.php">Buy points</a>).</td><?php
}
