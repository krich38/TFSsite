...
// Update logs:
mysql_insert("INSERT INTO `yz85_paygol` VALUES ('', '$custom', '$price', '$new_points', '$message_id', '$service_id', '$shortcode', '$keyword', '$message', '$sender', '$operator', '$country', '$currency')");

// Fetch points
$account = mysql_select_single("SELECT `points` FROM `yz85_accounts` WHERE `account_id`='$custom';");
