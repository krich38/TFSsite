...
$orders = mysql_select_multi('SELECT * FROM `yz85_shop_orders` ORDER BY `id` DESC;');
...
<?php
$orders = mysql_select_multi("SELECT `id`, `account_id`, `type`, `itemid`, `count`, `points`, `time` FROM `yz85_shop_logs` ORDER BY `id` DESC;");
?>
<h2>Order History</h2>
