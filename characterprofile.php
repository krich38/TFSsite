...
if ($config['log_ip']) {
	yz85_visitor_insert_detailed_data(4);
}
if (isset($_GET['name']) === true && empty($_GET['name']) === false) {
	...
	if ($user_id !== false) {
		...
		$profile_yz85_data = user_yz85_character_data($user_id, 'created', 'hide_char', 'comment');
		...
		<!-- PROFILE MARKUP HERE-->
			...
			<ul class="unstyled">
				...
				<li><font class="profile_font" name="profile_font_created">Created: <?php echo getClock($profile_yz85_data['created'], true); ?></font></li>
				<li><font class="profile_font" name="profile_font_comment">Comment:</font> <br><textarea name="profile_comment_textarea" cols="70" rows="10" readonly="readonly" class="span12"><?php echo $profile_yz85_data['comment']; ?></textarea></li>
	<!-- Achievements start -->
