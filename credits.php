...
<h1>yz85 AAC</h1>
<p>This website is powered by the yz85 AAC engine.</p>

<h2>Developers:</h2>
<p>Main: <a href="http://otland.net/members/yz85.5993/">yz85</a>.
<?php
...
<?php } else { // CURL enabled.
	...
	$curl = curl_init();
	curl_setopt($curl, CURLOPT_URL, 'https://api.github.com/repos/yz85/yz85AAC/contributors');
    curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
	curl_setopt($curl, CURLOPT_USERAGENT, 'yz85AAC'); // GitHub requires user agent header.
	...
	{
		if($contributor['login'] != 'yz85') { // Exclude yz85 as he is mentioned above as main developer.
