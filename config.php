<?php
	...
	$config['site_title'] = 'Project 8.6';
	$config['site_title_context'] = 'motd';
	...
	$config['sqlPassword'] = 'mj8bvtevr538';
	...
	$config['quests'] = array(
		array(1501,100,"Killing in the Name of",1),
	...
	*/
	...
	/* Download PHPMailer: https://github.com/PHPMailer/PHPMailer/archive/master.zip
		Extract to yz85 AAC directory (where this config.php file is located)
	...
	*/
	$config['mailserver'] = array(
		...
		'host' => "mailserver.yz85.eu", // Outgoing mail server host.
		'securityType' => 'ssl', // ssl or tls
		'port' => 465, // SMTP port number - likely to be 465(ssl) or 587(tls)
		'username' => 'noreply@yz85.eu', // Likely the email address
	...
	// Use yz85's External Open Tibia Services Server
	// Currently in Alpha and is pretty useless, but will contain paypal blacklist etc in future.
	// You can use the official server: http://zeotss.yz85.eu/
	// Or host your own private one, here is the code: https://github.com/yz85/ZEOTSS
	$config['zeotss'] = array(
		'enabled' => false,
		'visitors' => true,
		'debug' => false,
		'server' => "http://zeotss.yz85.eu/"
	);
	...
	*/
	...
	/// SHOP ///
	////////////
	// If useDB is set to true, player can shop in-game as well using yz85 LUA shop system plugin.
	$config['shop'] = array(
		'enabled' => true,
